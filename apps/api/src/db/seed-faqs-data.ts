// FAQ seed data and category mapping, extracted from seed-faqs.ts so the
// classification logic and data invariants (unique sortOrder, ja/en symmetry)
// are unit-testable without opening a DB connection.

export const JA_FAQS = [
  // ---- Overview ----
  {
...
export function resolveCategory(sortOrder: number): string {
  ...
  if (sortOrder >= 50 && sortOrder <= 53) return "friends";
