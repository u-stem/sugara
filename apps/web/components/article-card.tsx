  ...
  if (selectable) {
    return (
      ...
      >
        <Card
          className={cn(
            "h-full transition-[colors,transform,box-shadow] hover:bg-accent/50 hover:shadow-md lg:active:scale-[0.98] group-focus-visible:border-ring group-focus-visible:ring-2 group-focus-visible:ring-ring",
